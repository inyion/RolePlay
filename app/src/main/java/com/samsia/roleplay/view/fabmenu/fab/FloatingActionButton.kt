package com.samsia.roleplay.view.fabmenu.fab
...
import com.samsia.roleplay.view.fabmenu.Util
import com.samsia.roleplay.view.fabmenu.Util.dpToPx
import com.samsia.roleplay.view.fabmenu.Util.getColor
...
class FloatingActionButton @JvmOverloads constructor(
    ...
    private fun getCircleSize(): Int =
        resources.getDimensionPixelSize(if (fabSize == SIZE_NORMAL) R.dimen.fab_size_normal else if(fabSize== SIZE_MINI) R.dimen.fab_size_mini else R.dimen.fab_size_tiny)
